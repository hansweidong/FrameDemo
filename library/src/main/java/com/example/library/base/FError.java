...
public class FError {
    ...
    private static final String TAG = FError.class.getSimpleName();

    private static Context context;

    public static void init(Context context) {
        FError.context = context;
    }
