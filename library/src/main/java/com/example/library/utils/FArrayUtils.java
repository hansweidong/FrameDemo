...
public class FArrayUtils {
    ...
    public static <V> V getLast(V[] sourceArray, V value, V defaultValue, boolean isCircle) {
        ...
        for (int i = 0; i < sourceArray.length; i++) {
            if (FObjectUtils.isEquals(value, sourceArray[i])) {
                currentPosition = i;
                break;
            }
        }
    ...
    /**
     * @see {@link FArrayUtils#getLast(Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link FArrayUtils#getNext(Object[], Object, Object, boolean)} defaultValue is null
     */
    ...
    /**
     * @see {@link FArrayUtils#getLast(Object[], Object, Object, boolean)} Object is Long
     */
    public static long getLast(long[] sourceArray, long value, long defaultValue, boolean isCircle) {
        ...
        Long[] array = FObjectUtils.transformLongArray(sourceArray);
        return getLast(array, value, defaultValue, isCircle);

    }

    /**
     * @see {@link FArrayUtils#getNext(Object[], Object, Object, boolean)} Object is Long
     */
    ...
    /**
     * @see {@link FArrayUtils#getLast(Object[], Object, Object, boolean)} Object is Integer
     */
    public static int getLast(int[] sourceArray, int value, int defaultValue, boolean isCircle) {
        ...
        Integer[] array = FObjectUtils.transformIntArray(sourceArray);
        return getLast(array, value, defaultValue, isCircle);

    }

    /**
     * @see {@link FArrayUtils#getNext(Object[], Object, Object, boolean)} Object is Integer
     */
