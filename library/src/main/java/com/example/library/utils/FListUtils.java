...
public class FListUtils {
    ...
    public static <V> boolean isEquals(ArrayList<V> actual, ArrayList<V> expected) {
        ...
        for (int i = 0; i < actual.size(); i++) {
            if (!FObjectUtils.isEquals(actual.get(i), expected.get(i))) {
                return false;
            }
        }
        return true;
    ...
    /**
     * @see {@link FArrayUtils#getLast(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getLast(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V) FArrayUtils.getLast(sourceList.toArray(), value, true);
    }

    /**
     * @see {@link FArrayUtils#getNext(Object[], Object, Object, boolean)} defaultValue is null, isCircle is true
     */
    @SuppressWarnings("unchecked")
    public static <V> V getNext(List<V> sourceList, V value) {
        return (sourceList == null) ? null : (V) FArrayUtils.getNext(sourceList.toArray(), value, true);
    }
    /**
     * invert list
     *
