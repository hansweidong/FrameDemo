 ...
 */
public class FResourceUtils {

    private FResourceUtils() {
    ...
    /**
     * same to {@link FResourceUtils#geFileFromAssets(Context, String)}, but return type is List<String>
     *
     * @param context
     * @param fileName
     * @return
    ...
    /**
     * same to {@link FResourceUtils#geFileFromRaw(Context, int)}, but return type is List<String>
     *
     * @param context
     * @param resId
     * @return
