 ...
 * <li>{@link FPackageUtils#installNormal(Context, String)}</li>
 * <li>{@link FPackageUtils#installSilent(Context, String)}</li>
 * <li>{@link FPackageUtils#install(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link FPackageUtils#uninstallNormal(Context, String)}</li>
 * <li>{@link FPackageUtils#uninstallSilent(Context, String)}</li>
 * <li>{@link FPackageUtils#uninstall(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link FPackageUtils#isSystemApplication(Context)}</li>
 * <li>{@link FPackageUtils#isSystemApplication(Context, String)}</li>
 * <li>{@link FPackageUtils#isSystemApplication(PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link FPackageUtils#getInstallLocation()} get system install location</li>
 * <li>{@link FPackageUtils#isTopActivity(Context, String)} whether the app whost package's name is packageName is on the
 * top of the stack</li>
 * <li>{@link FPackageUtils#startInstalledAppDetails(Context, String)} start InstalledAppDetails Activity</li>
 * </ul>
 *
 * @author <a href="http://www.trinea.cn" target="_blank">Trinea</a> 2013-5-15
 */
public class FPackageUtils {

    public static final String TAG = "FPackageUtils";

    private FPackageUtils() {
    ...
    public static final int install(Context context, String filePath) {
        if (FPackageUtils.isSystemApplication(context) || FShellUtils.checkRootPermission()) {
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link FPackageUtils#INSTALL_SUCCEEDED} means install success, other means failed. details see
     *         {@link FPackageUtils}.INSTALL_FAILED_*. same to {@link PackageManager}.INSTALL_*
    ...
    public static int installSilent(Context context, String filePath, String pmParams) {
        ...
        FShellUtils.CommandResult commandResult = FShellUtils.execCommand(command.toString(), !isSystemApplication(context), true);
    ...
    public static int getInstallLocation() {
        FShellUtils.CommandResult commandResult = FShellUtils.execCommand(
