package com.example.library.cache.sp;
 ...
 */
public class FSharePreferenceUtil {

    private SharedPreferences settings;

    public FSharePreferenceUtil(Context context) {
        this(context, null);
    }

    // private Editor editor;
    @SuppressWarnings("static-access")
    public FSharePreferenceUtil(Context context, String sharePreFileName) {
